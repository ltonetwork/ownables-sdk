...
const CONTRACT_NAME: &str = "crates.io:ownable_second_build_test";
...
pub fn instantiate(
    ...
    let ownable_info = OwnableInfo {
        ...
        ownable_type: Some("second build test".to_string()),
    };
    ...
    let metadata = Metadata {
        ...
        image_data: None,
        external_url: None,
        description: Some("test for portrait in square".to_string()),
        name: Some("second build test".to_string()),
