...
pub fn instantiate(
    ...
    let ownable_info = OwnableInfo {
        ...
        ownable_type: Some("ownable type".to_string()),         // replace with your ownable type
    };
    ...
    let metadata = Metadata {
        ...
        image_data: None,
        external_url: None,
        description: Some("ownable description".to_string()),   // replace with your ownable description
        name: Some("ownable name".to_string()),                 // replace with your ownable name
